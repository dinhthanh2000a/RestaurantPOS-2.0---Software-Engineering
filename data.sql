...
# add admin # default
INSERT INTO EMPLOYEES VALUE('hoainam','Nguyễn Hoài Nam','1234567890abc','2001-10-11',0234324234,'nam@gmail.com','');
#INSERT INTO USERS VALUE('thuyngan','Phạm Thị Thúy Ngân','thuyngan01','2001-10-11',0324343466);
...
SELECT * FROM CART;
#DELETE FROM CART WHERE IDCART >= 0;
...
INSERT INTO PAYMENT(QUANTITY,PRICE,TOTALPRICE,PAYTIME,METHODS,IDCART) VALUE(2,200000,PRICE*1.1,NOW(),'CASH','0101');
INSERT INTO PAYMENT(QUANTITY,PRICE,TOTALPRICE,PAYTIME,METHODS,IDCART) VALUE(2,180000,PRICE*1.1,NOW(),'CASH','0102');
INSERT INTO PAYMENT(QUANTITY,PRICE,TOTALPRICE,PAYTIME,METHODS,IDCART) VALUE(1,60000,PRICE*1.1,NOW(),'CASH','0103');